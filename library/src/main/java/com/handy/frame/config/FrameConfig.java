...
public class FrameConfig {
    ...
    public static final String PROMPT_ERROR_TIMEOUT = "服务连接超时，请稍后再试";
    public static final String PROMPT_ERROR_REQUEST = "请求数据错误，请联系管理员";
    public static final String PROMPT_ERROR_ANALYSIS = "服务返回数据解析失败，请联系管理员";
    public static final String PROMPT_ERROR_RESPONSE = "服务返回数据错误，请联系管理员";
    public static final String PROMPT_ERROR_SERVER = "服务异常，请联系管理员";
