...
public abstract class BaseLoginActivity extends LocalBaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.frame_activity_login);
    ...
    public void initViewHDB(@Nullable Bundle savedInstanceState) {
        ...
        btnSignin.setOnClickListener(v -> {
            ...
            setSigninListener(edtUsername.getText().toString().trim(), edtPassword.getText().toString().trim());
        });
    }

    protected abstract void setSigninListener(String username, String password);
}
